...
export default function FeaturesIlles() {
  return (
    <div style={{ background: '#080921' }}>
      <section className="py-24 ">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-14 text-center">
            <h2 className="text-4xl text-center font-bold text-white leading-[3.25rem] mb-6 max-w-max lg:max-w-3xl lg:mx-auto">
              {content.features2.title}
            </h2>
            <p className="text-base font-normal text-gray-500 lg:max-w-2xl lg:mx-auto mb-8">
              {content.features2.description}
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-lg mx-auto md:max-w-2xl lg:max-w-full">
              ...
              <div className="bg-gray-800 rounded-2xl flex  justify-between flex-row flex-wrap">
                <div className="p-5  xl:p-8 w-full md:w-1/2 ">
                  ...
                  <h3 className="text-lg font-bold xl:text-xl text-white py-5 w-full xl:w-64">
                    {content.features2.cards[0].title}
                  </h3>
                  <p className="text-xs font-normal text-gray-300 w-full mb-8 xl:w-64">
                    {content.features2.cards[0].description}
                  </p>
                  <Link
            ...
            <div className="relative w-full h-auto">
              <div className="bg-indigo-500 rounded-2xl p-5  xl:p-8 h-full">
                ...
                <h3 className="py-5 text-white text-lg font-bold xl:text-xl">
                  {content.features2.cards[1].title}
                </h3>
                <p className="text-xs font-normal text-white mb-8">
                  {content.features2.cards[1].description}
                </p>
                <Link
                  href="/tailwind-playground"
                  className="py-2 px-5 border border-solid border-gray-300 rounded-full gap-2 text-xs text-white font-semibold flex items-center justify-between transition-all duration-500 hover:bg-white/5"
            ...
            <div className="relative w-full h-auto">
              <div className="bg-violet-500 rounded-2xl p-5 xl:p-8 h-full">
                ...
                <h3 className="py-5 text-white text-lg font-bold xl:text-xl">
                  {content.features2.cards[2].title}
                </h3>
                <p className="text-xs font-normal text-white mb-8">
                  {content.features2.cards[2].description}
                </p>
                <Link
                  href="/tailwind-playground"
                  className="py-2 px-5  border border-solid border-gray-300 rounded-full gap-2 text-xs text-white font-semibold flex items-center justify-between transition-all duration-500 hover:bg-white/5"
